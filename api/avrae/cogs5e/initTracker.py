...
from api.avrae.cogs5e.funcs import attackutils, targetutils
from api.avrae.cogs5e.funcs.dice import roll
from api.avrae.cogs5e.funcs.lookupFuncs import select_monster_full, select_spell_full
from api.avrae.cogs5e.funcs.scripting import helpers
from api.avrae.cogs5e.models import embeds
from api.avrae.cogs5e.models.character import Character
from api.avrae.cogs5e.models.embeds import EmbedWithAuthor, EmbedWithCharacter
from api.avrae.cogs5e.models.errors import InvalidArgument, SelectionException
from api.avrae.cogs5e.models.initiative import Combat, Combatant, CombatantGroup, Effect, MonsterCombatant, PlayerCombatant
from api.avrae.cogs5e.models.sheet.attack import Attack
from api.avrae.cogs5e.models.sheet.base import Resistances, Skill
from cogsmisc.stats import Stats
from api.avrae.utils.argparser import argparse, argsplit
from api.avrae.utils.functions import confirm, search_and_select, try_delete
