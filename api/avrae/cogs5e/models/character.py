...
from api.avrae.cogs5e.funcs.scripting.evaluators import MathEvaluator, ScriptingEvaluator
from api.avrae.cogs5e.models.dicecloud.integration import DicecloudIntegration
from api.avrae.cogs5e.models.embeds import EmbedWithCharacter
from api.avrae.cogs5e.models.errors import InvalidArgument, NoCharacter, NoReset
from api.avrae.cogs5e.models.sheet.attack import AttackList
from api.avrae.cogs5e.models.sheet.base import BaseStats, Levels, Resistances, Saves, Skills
from api.avrae.cogs5e.models.sheet.player import CharOptions, CustomCounter, DeathSaves, ManualOverrides
from api.avrae.cogs5e.models.sheet.spellcasting import Spellbook, SpellbookSpell
from api.avrae.cogs5e.models.sheet.statblock import DESERIALIZE_MAP as _DESER, StatBlock
from api.avrae.cogs5e.sheets.abc import SHEET_VERSION
...
class Character(StatBlock):
    ...
    def __init__(self, owner: str, upstream: str, active: bool, sheet_type: str, import_version: int,
                 ...
                 spellbook: Spellbook,
                 live, race: str, background: str, xp: int, **kwargs):
        if kwargs:
    ...
    def to_dict(self):
        ...
        d.update({
            ...
            "background": self.background, "xp":self.xp
        })
        return d
