...
from api.avrae.cogs5e.models.embeds import HomebrewEmbedWithAuthor
from api.avrae.cogs5e.models.errors import NoActiveBrew, NoSelectionElements, NotAllowed
from api.avrae.cogs5e.models.homebrew import Pack, Tome
from api.avrae.cogs5e.models.homebrew.bestiary import Bestiary, select_bestiary
from api.avrae.utils import checks
from api.avrae.utils.functions import confirm, search_and_select
