...
from api.avrae.cogs5e.funcs.scripting.functions import SimpleRollResult
from api.avrae.cogs5e.models.errors import CombatNotFound, InvalidSaveType
from api.avrae.cogs5e.models.initiative import Combat, Combatant, CombatantGroup, Effect
from api.avrae.cogs5e.models.sheet.statblock import StatBlock
from api.avrae.utils.argparser import ParsedArguments
...
class SimpleCombatant:
    ...
    def damage(self, dice_str, crit=False, d=None, c=None, critdice=0, overheal=False):
        ...
        :rtype: dict
        """
        from api.avrae.cogs5e.models.automation import AutomationContext, AutomationTarget, \
